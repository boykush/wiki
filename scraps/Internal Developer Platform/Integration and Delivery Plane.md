...
[[Internal Developer Platform]]の参照アーキテクチャを構成する5つのプレーンの1つで、イメージをビルドして保存し、開発者が渡した抽象からアプリとインフラの設定を作り、最終状態をデプロイする部分。開発者とプラットフォームエンジニアの領分が出会う場所で、CI・イメージレジストリ・オーケストレーター・CD の4つからなる
