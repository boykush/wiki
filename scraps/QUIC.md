...
インターネット上の通信で多く用いられてきた[[TCP]]の課題を解消する、[[Google]]が開発したプロトコル

[[UDP]]をベースとし、コネクション確立によるRTTの増大を防ぎつつ、TCPと同様の高い信頼性の実現、[[TLS]]を必須とするセキュリティの考慮がされる。

[[HTTP/3]]で用いられるプロトコルで高速な[[HTTPS]]通信を実現する
