...
- 近年の [`tj-actions/changed-files` 事件](https://www.stepsecurity.io/blog/harden-runner-detection-tj-actions-changed-files-action-is-compromised)はこのパターン: 同一 tag が遡及的に汚染されたコミットへ rebound された
